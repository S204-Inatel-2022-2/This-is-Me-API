Feature: Everything about Character API
  ...
  Scenario: Get Character, Criar usuário, Logar com usuário criado, Fazer o GetCharacter, Deletar usuário criado (Success)
  ...
  Scenario: Get Character All Infos, Criar usuário, Logar com usuário criado, Fazer o GetCharacter, Deletar usuário criado (Success)
    Given path '/user/register'
    And def email = createdEmail()
    And request email.register
    When method post
  ...
  Scenario: Post Character, Criar usuário, Logar com usuário criado, Setar uma roupa existente, Deletar usuário criado (Success)
    Given path '/user/register'
    And def email = createdEmail()
    And request email.register
    When method post
  ...
  Scenario: Post Character, Criar usuário, Logar com usuário criado, Setar uma roupa não existente(dez 9), Deletar usuário criado (Bad Request)
    Given path '/user/register'
    And def email = createdEmail()
    And request email.register
    When method post
